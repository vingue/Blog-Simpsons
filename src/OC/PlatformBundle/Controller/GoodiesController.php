...
public function articleAction($id)
	{		
		...
		return $this->render('OCPlatformBundle:Goodies:article.html.twig', array('title' => $titre,'contenu' => $contenu, 'lien' => $url));
	...
	public function supprimerAction($id)
{
  ...
  $em->flush();        
	...
	public function afficheListAction()
	{
		...
		return $this->render('OCPlatformBundle:Goodies:projet_affiche_tous.html.twig', array('projects' => $ent));
		exit;
